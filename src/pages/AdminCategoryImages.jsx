...
export default function AdminCategoryImages() {
  ...
  return (
    <div className="max-w-4xl">
      <Link
        to="/admin/products"
        className="text-sm text-stone-500 dark:text-stone-400 hover:text-emerald-600 dark:hover:text-emerald-400 mb-3 inline-block"
      >
        ← Products (dev tools)
      </Link>
      <h1 className="text-xl font-bold text-stone-800 dark:text-stone-100 mb-2">Category images</h1>
      <p className="text-sm text-stone-600 dark:text-stone-400 mb-4">Home page category cards.</p>
