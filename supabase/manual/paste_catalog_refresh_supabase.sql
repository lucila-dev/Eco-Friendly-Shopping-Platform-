...
-- Refreshes generated product names, descriptions, materials, scores, and carbon — leaves existing image_url unchanged for rows that already exist.
